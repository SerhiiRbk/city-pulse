    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden bg-gray-900">
        <div
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1540575467063-178a50e2fd60?w=1600&q=80')" }}
        />
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {featureCards.map(({ icon: Icon, title, desc }) => (
            <Card key={title} className="group border-border/50 bg-background/50 rounded-3xl shadow-none backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              <CardHeader>
                <div className="bg-primary/10 mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl transition-colors group-hover:bg-primary/20">
